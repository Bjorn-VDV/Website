...
function footerRepeat()
{
    ...
    result += "<div class='dropdown;positionSticker'><button onclick='menuButton()' class='dropbtn'>MENU</button><div id='myDropdown' class='dropdown-content'>" + 
        ...
        "<a href='https://bjorn-vdv.github.io/Website/html/About.html'>ABOUT</a>" + 
        "<a href='https://bjorn-vdv.github.io/Website/html/Products.html'>PRODUCTS</a>" +
        "<a href='https://bjorn-vdv.github.io/Website/html/Contact.html'>CONTACT</a>" +     
        "</div></div>"

    result += "<a href='https://sv-se.facebook.com/' class='positionSticker' target='_blank'>" + 
    "<img src='https://bjorn-vdv.github.io/Website/Images/fbLogo.png' alt='Facebook Logo' style='width: 12%; height: 12%;min-width: 25px;'>Facebook!</a>";

    result += "<a href='https://www.instagram.com/' class='positionSticker' target='_blank'>" +
    "<img src='https://bjorn-vdv.github.io/Website/Images/instaLogo.jpg' alt='Instagram Logo' style='width: 12%; height: 12%;min-width: 25px;'>Instagram!</a>";
